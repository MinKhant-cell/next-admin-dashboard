...
function ActionDropdown(props: {
  ...
  return (
    <div>
        ...
        <DropdownMenuContent className="z-[80] w-40 border-zinc-200 dark:border-zinc-800">
          <DropdownMenuGroup>
            <DropdownMenuItem asChild>
              <Link
                href={`/dashboard/classrooms/edit/${id}`}
      ...
      <ConfirmDialog isOpen={confirmDialogOpen} onOpenChange={setConfirmDialogOpen} title='Delete Classroom' description='Please Confirm to Delete!' onConfirm={()=>onDelete(id)}/>
    </div>
  );
}
