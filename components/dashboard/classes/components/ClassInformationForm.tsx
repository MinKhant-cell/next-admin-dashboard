  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid gap-2">
        ...
        <Select onValueChange={teacher_id.field.onChange} value={teacher_id.field.value}>
     ...
     <div className="grid gap-2">
      ...
      <div className="grid gap-2">
        <Label className="text-gray-600 dark:text-zinc-200" htmlFor="description">
          Description
        </Label>
